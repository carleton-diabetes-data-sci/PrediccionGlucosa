def procesaDatosComidas(root, pacientes, posicion_glucosa):
    ...
    for paciente in pacientes:
        ...
        datos_procesados = pd.read_csv(root + paciente + '/datos_procesados.csv')
        ...
        df.to_csv(root + paciente + '/comidas_procesadas.csv', index=False)