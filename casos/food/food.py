...
from casos.food.food_graph import crear_grafica_calidad

def bloque_comida(cn, pi, patient_digit, path_food_graphs, path_food_dataset, path_food_dataset_processed, posicion_glucosa, pacientes):
    ...
    #anadeComidaProcesada(cn, pi, patient_digit, path_full_dataset_processed, posicion_glucosa, pacientes)
