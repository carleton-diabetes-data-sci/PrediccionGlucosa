...
def bloque_glucosa_aceleracion(cn, pi, path_glucose_acceleration_graphs, path_glucose_dataset, pacientes):
  ...
  crear_grafica_glucosa(cn, pi, path_glucose_acceleration_graphs,  path_glucose_dataset)
