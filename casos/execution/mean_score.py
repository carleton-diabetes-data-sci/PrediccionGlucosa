...
def media_resultados_pacientes(cn, path_scores_dataset_processed, pacientes):
    ...
    mean_scores_list.append(['mean_mean_relevant_patients_case_' + str(cn), np.mean(mean_scores_exp_1), np.mean(mean_scores_exp_2),np.mean(mean_scores_exp_3), np.mean(mean_scores_exp_4), np.mean(mean_scores_exp_5), np.mean(mean_scores_exp_6), np.mean(mean_scores_exp_7)])
    min_scores_list.append(['min_min_relevant_patients_case_' + str(cn), np.amin(min_scores_exp_1), np.amin(min_scores_exp_2),np.amin(min_scores_exp_3), np.amin(min_scores_exp_4), np.amin(min_scores_exp_5), np.amin(min_scores_exp_6), np.amin(min_scores_exp_7)])
    max_scores_list.append(['max_max_relevant_patients_case_' + str(cn), np.amax(max_scores_exp_1), np.amax(max_scores_exp_2), np.amax(max_scores_exp_3), np.amax(max_scores_exp_4), np.amax(max_scores_exp_5), np.amax(max_scores_exp_6), np.amax(max_scores_exp_7)])
