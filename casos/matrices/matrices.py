...
from casos.matrices.separation import separar_train_val_test, bloque_dividir_datos


def bloque_matriz(cn, path_full_dataset_processed, paciente, posicion_glucosa, datosProcesados, path_models_saved):
    """
